...
def get_cars(**kwargs):
    ...
    url_stream = f"https://integrate.us.mixtelematics.com/api/assets/group/{hp_mix_group_id}"
...
def transmission_gcp(**kwargs):
    ...
    gcs_hook.upload(
        ...
        object_name=f"mix/cars/cars.parquet",
...
def insert_dag_metadata(**kwargs):
    ...
    gcs_hook.upload(
        bucket_name=hp_gcp_bucket_name_raw,
        object_name=f"mix/metadata/cars/pipeline_hp_telemetics_cars_{execution_date}.json",
...
def atualizar_tabela_bigquery(**kwargs):
    ...
    gcs_to_bigquery = GCSToBigQueryOperator(
        ...
        source_objects=[f"mix/cars/*.parquet"],
        destination_project_dataset_table='gcp-hp-proj-operacao.dev.cars',
